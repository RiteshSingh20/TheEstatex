...
interface CommercialRentalPropertyFormProps {
  onBack?: () => void;
}
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-slate-700 text-white px-8 py-4 flex justify-between items-center shadow-lg">
        <h1 className="text-xl font-semibold"><i className="fas fa-cogs"></i> Commercial Rental Property Management</h1>
      ...
      <div className="bg-white px-8 py-4 border-b border-gray-200 text-sm text-gray-600">
        <a href="#" className="text-blue-500 no-underline">Dashboard</a> / <a href="#" className="text-blue-500 no-underline">Properties</a> / <strong>Add Commercial Rental Property</strong>
      </div>
        ...
        <div className="max-w-7xl mx-auto p-0.5">
          {onBack && (
            <div className="px-8 py-4 text-left">
              <button onClick={onBack} className="px-3 py-2 bg-gradient-to-r from-gray-400 to-gray-300 text-white border border-gray-500 rounded cursor-pointer text-xs font-semibold transition-all duration-200 inline-flex items-center gap-1 shadow-sm hover:from-gray-500 hover:to-gray-400 hover:-translate-y-0.5 hover:shadow-md">
                <i className="fas fa-arrow-left"></i> Back to Form Selection
              </button>
            </div>
          )}

          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-2 rounded-lg shadow-lg mb-6 text-white">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <form>
                  ...
                  <div className="block">
                            ...
                            {shouldShowField('parking') && (
                              <div className="p-1">
                                <div className="flex gap-2">
                                  <select name="parking" value={formData.parking} onChange={handleInputChange} className={`p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white cursor-pointer ${formData.parking === 'Available' ? 'w-28' : 'flex-1'}`}>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 mb-6 shadow-sm border border-gray-200">
                      <div className={`grid gap-1 bg-white rounded border border-gray-200 p-1`} style={{gridTemplateColumns: `repeat(${getColumnCount(3)}, 1fr)`}}>
                        ...
                        {(formData.configuration === 'Big Commercials' || formData.configuration === 'Industrial') && <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Security Deposit (₹)</div>}
                        {shouldShowField('securityDeposit') && !(formData.configuration === 'Big Commercials' || formData.configuration === 'Industrial') && <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Security Deposit (₹)</div>}
                        ...
                        <div className="p-1"><input name="expectedRent" value={formData.expectedRent} onChange={handleInputChange} placeholder="Monthly Rent" required className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" /></div>
                        <div className="p-1">
                        ...
                        {(formData.configuration === 'Big Commercials' || formData.configuration === 'Industrial') && <div className="p-1"><input name="securityDeposit" value={formData.securityDeposit} onChange={handleInputChange} placeholder="Security Deposit" className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" /></div>}
                        {shouldShowField('securityDeposit') && !(formData.configuration === 'Big Commercials' || formData.configuration === 'Industrial') && <div className="p-1"><input name="securityDeposit" value={formData.securityDeposit} onChange={handleInputChange} placeholder="Security Deposit" className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" /></div>}
                        ...
                        <div className="p-1">
                          <div className="flex gap-2">
                            <select name="plusProperty" value={formData.plusProperty} onChange={handleInputChange} className="flex-1 min-w-0 p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white cursor-pointer">
              ...
              <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex justify-between items-center">
                <div>
                  <button type="button" className="px-3 py-2 bg-gradient-to-r from-gray-400 to-gray-300 text-white border border-gray-500 rounded cursor-pointer text-xs font-semibold transition-all duration-200 inline-flex items-center gap-1 shadow-sm hover:from-gray-500 hover:to-gray-400 hover:-translate-y-0.5 hover:shadow-md" onClick={handlePrevious} style={{display: currentTab === 0 ? 'none' : 'inline-flex'}}>
                    <i className="fas fa-arrow-left"></i> Previous
                  </button>
                </div>
                <div className="ml-auto">
                  <button type="button" className="px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-400 text-white border border-blue-600 rounded cursor-pointer text-xs font-semibold transition-all duration-200 inline-flex items-center gap-1 shadow-sm hover:from-blue-600 hover:to-blue-500 hover:-translate-y-0.5 hover:shadow-md" onClick={handleNext} style={{display: currentTab === tabs.length - 1 ? 'none' : 'inline-flex'}}>
                    Next <i className="fas fa-arrow-right"></i>
                  </button>
                  <button type="submit" className="px-3 py-2 bg-gradient-to-r from-green-500 to-green-400 text-white border border-green-600 rounded cursor-pointer text-xs font-semibold transition-all duration-200 inline-flex items-center gap-1 shadow-sm hover:from-green-600 hover:to-green-500 hover:-translate-y-0.5 hover:shadow-md" style={{display: currentTab === tabs.length - 1 ? 'inline-flex' : 'none'}}>
...
export default CommercialRentalPropertyForm;