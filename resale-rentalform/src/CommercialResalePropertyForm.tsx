  ...
  return (
    <div className="min-h-screen">
      <div className="bg-slate-700 text-white px-8 py-4 flex justify-between items-center shadow-lg">
        <h1 className="text-xl font-semibold"><i className="fas fa-cogs"></i> Commercial Resale Property Management</h1>
      ...
      <div className="bg-white px-8 py-4 border-b border-gray-200 text-sm text-gray-600">
        <a href="#" className="text-blue-500 no-underline">Dashboard</a> / <a href="#" className="text-blue-500 no-underline">Properties</a> / <strong>Add Commercial Resale Property</strong>
      </div>
