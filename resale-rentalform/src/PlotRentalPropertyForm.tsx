  ...
  return (
    <div className="min-h-screen">
      <div className="bg-slate-700 text-white px-8 py-4 flex justify-between items-center shadow-lg">
        <h1 className="text-xl font-semibold"><i className="fas fa-cogs"></i> Plot Rental Management</h1>
      ...
      <div className="bg-white px-8 py-4 border-b border-gray-200 text-sm text-gray-600">
        <a href="#" className="text-blue-500 no-underline">Dashboard</a> / <a href="#" className="text-blue-500 no-underline">Properties</a> / <strong>Add Plot Rental</strong>
      </div>
      ...
      <div className="min-h-[calc(100vh-120px)]">
        <div className="max-w-7xl mx-auto p-0.5">
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-2 rounded-lg shadow-lg mb-1 text-white">
            <h2 className="text-lg font-bold mb-0.5">Add Plot Rental</h2>
            <p className="opacity-90 text-sm">Enter comprehensive plot details and rental information</p>
          </div>
              ...
              <div className="pt-6 pb-1.5 px-1.5">
                ...
                {currentTab === 1 && (
                  <div className="block">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 mb-6 shadow-sm border border-gray-200">
                      <div className="font-bold text-gray-800 mb-1 text-sm flex items-center before:content-['▶'] before:text-blue-600 before:mr-2 before:text-xs">Rental Information</div>
                      <div className="grid grid-cols-5 gap-1 bg-white rounded border border-gray-200 p-1">
                        <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Monthly Rent (₹)</div>
                        <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Security Deposit (₹)</div>
                        <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Lease Period</div>
                        ...
                        <div className="p-1">
                          <input name="monthlyRent" value={formData.monthlyRent} onChange={handleInputChange} placeholder="Enter monthly rent" className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" />
                        </div>
                        <div className="p-1">
                          <input name="securityDeposit" value={formData.securityDeposit} onChange={handleInputChange} placeholder="Enter security deposit" className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" />
                        </div>
                        <div className="p-1">
                          <select name="leasePeriod" value={formData.leasePeriod} onChange={handleInputChange} className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white cursor-pointer">
...
export default PlotRentalPropertyForm;