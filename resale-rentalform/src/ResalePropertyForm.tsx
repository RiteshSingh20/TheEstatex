...
const ResalePropertyForm: React.FC<ResalePropertyFormProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-slate-700 text-white px-8 py-4 flex justify-between items-center shadow-lg">
        <h1 className="text-xl font-semibold"><i className="fas fa-cogs"></i> Resale Property Management</h1>
      ...
      <div className="bg-white px-8 py-4 border-b border-gray-200 text-sm text-gray-600">
        <a href="#" className="text-blue-500 no-underline">Dashboard</a> / <a href="#" className="text-blue-500 no-underline">Properties</a> / <strong>Add Resale Property</strong>
      </div>
            ...
            <form>
              ...
              <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex justify-between items-center">
                ...
                <div className="ml-auto">
                  ...
                  <button
                    type="submit"
                    className="px-3 py-2 bg-gradient-to-r from-green-500 to-green-400 text-white border border-green-600 rounded cursor-pointer text-xs font-semibold transition-all duration-200 inline-flex items-center gap-1 shadow-sm hover:from-green-600 hover:to-green-500 hover:-translate-y-0.5 hover:shadow-md"
