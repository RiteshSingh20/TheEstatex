      ...
      <div className="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center">
        ...
        <div className="flex-1 relative group">
          ...
          <input
            ...
            onChange={(e) => setRejectedSearchTerms((prev) => ({
              ...prev,
        ...
        <div className="flex gap-2 lg:gap-3">
          ...
          <div className="relative">
            <select
              ...
              onChange={(e) => setRejectedFilters((prev) => ({
                ...prev,
                rental: {
                  ...prev.rental,
                  type: e.target.value,
              ...
              {filteredRejectedProperties.rental.map(
                (property: Property, index) => (
                  <tr
                    ...
                    className={`hover:bg-red-50 transition-colors ${index % 2 === 0 ? "bg-white" : "bg-red-25"}`}
                  >
                      ...
                      <div className="flex justify-center space-x-1">
                        ...
                        {user?.role === "admin" && (
                          <Button
                            size="sm"
                            variant="primary"
                            onClick={() => handleApproveRejectedProperty(
