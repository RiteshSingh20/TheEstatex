...
interface KeyAvailableIconProps {
  isKeyAvailable: boolean | string;
  size?: 'sm' | 'md' | 'lg';
}

const KeyAvailableIcon: React.FC<KeyAvailableIconProps> = ({ isKeyAvailable, size = 'sm' }) => {
  const isAvailable = typeof isKeyAvailable === 'string' 
    ? ['yes', 'true'].includes(isKeyAvailable.toLowerCase()) 
    : isKeyAvailable;
...
export default KeyAvailableIcon;
