        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="border relative">
            ...
            <div className="bg-white pb-8">
              {(siteHeads.length > 0 ? siteHeads : [{ name: "", contact: "" }]).map((head, index) => (
                <div key={index} className={`p-1 ${index > 0 ? "border-t" : ""}`}>
                  <div className="grid grid-cols-2 gap-2 items-center">
                    <input
                      ...
                      value={head.name}
                      onChange={(e) => {
                        const newHeads = siteHeads.length > 0 ? [...siteHeads] : [{ name: "", contact: "" }];
          ...
          <div className="relative border">
            ...
            <div className="bg-white pb-10">
              {(sourcingManagers.length > 0 ? sourcingManagers : [{ name: "", contact: "" }]).map((manager, index) => (
                <div key={index} className={`p-1 ${index > 0 ? "border-t" : ""}`}>
                  <div className="grid grid-cols-2 gap-2 items-center">
                    <input
                      type="text"
                      value={manager.name}
                      onChange={(e) => {
                        const newManagers = sourcingManagers.length > 0 ? [...sourcingManagers] : [{ name: "", contact: "" }];
