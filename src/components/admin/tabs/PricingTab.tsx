...
type StationPricing = { actual: number; offer: number };
...
type Props = {
  ...
  setPricingState: (updater: any) => void;
  currentPricing: {
    actualPrice?: { RR: number };
    discountedPrice?: { RR: number };
  };
  setCurrentPricing: (v: any) => void;
  setPricing: (payload: any) => Promise<void> | void;
  newPropertyPricing: { [key: string]: StationPricing };
  setNewPropertyPricing: (updater: any) => void;
  customStationNames: { [key: string]: string };
  setCustomStationNames: (v: any) => void;
  newStationPricing: StationPricing;
  setNewStationPricing: (updater: any) => void;
  durationDiscounts: { 3: number; 6: number; 12: number };
  setDurationDiscounts: (updater: any) => void;
  stationSearchTerm: string;
  setStationSearchTerm: (v: string) => void;
  showStationDropdown: boolean;
  setShowStationDropdown: (v: boolean) => void;
  allMergedStations: { id: string; name: string }[];
  editingStationId: string | null;
  setEditingStationId: (v: string | null) => void;
  editingStationName: string;
  setEditingStationName: (v: string) => void;
  getDynamicCostSheetStationCount: () => number;
  setDoc: (ref: any, data: any, options?: any) => Promise<void> | void;
  doc: (...args: any[]) => any;
  db: any;
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                setCustomStationNames(updatedStationNames);
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setNewPropertyPricing((prev: any) => ({
                                      ...prev,
                                      [pricing.selectedStationId!]: {
                      ...
                      <div className="bg-white rounded-lg border border-neutral-200">
                        <div className="p-4 border-b border-neutral-200">
                          <h5 className="font-semibold text-neutral-800 flex items-center gap-2">
                            ...
                            All {getDynamicCostSheetStationCount()} Stations
                          </h5>
                        </div>
