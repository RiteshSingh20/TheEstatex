...
const Admin = () => {
  ...
  const saveEditedProperty = async () => {
    ...
    try {
      ...
      // Convert string values to appropriate types for resale properties
      if (category === "resale") {
        processedData = {
          ...processedData,
