...
const ResalePropertyForm: React.FC<ResalePropertyFormProps> = ({ onBack, editProperty }) => {
  ...
  useEffect(() => {
    ...
    if (editProperty) {
      setFormData({
        ...
        ocAvailable: editProperty.ocAvailable ? 'Yes' : 'No',
        ...
        expectedPrice: editProperty.expectedPrice?.toString() || '',
        negotiable: editProperty.negotiable ? 'Yes' : 'No',
        ...
        <div className="max-w-7xl mx-auto p-0.5">
          <div className="bg-white rounded-lg shadow-card overflow-hidden mb-1">
            <div className="bg-gradient-to-r from-primary to-primary-dark p-4 text-white">
              <h2 className="text-lg font-bold mb-0.5">Add Resale Property</h2>
              <p className="opacity-90 text-sm">Enter comprehensive property details and configuration settings</p>
            </div>
                    ...
                    <div className="grid grid-cols-7 gap-1 bg-white rounded border border-gray-200 p-1" style={{gridTemplateColumns: '1fr 1fr 1fr 1.5fr 0.6fr 1fr 1fr'}}>
                      ...
                      <div className="p-1">
                        <LocationDropdown
                          ...
                          onChange={(value) => {
                            setFormData(prev => ({
                              ...prev,
                              locationStation: value,
                              sublocation: '',
                              landmark: '',
                            }));
                          }}
                          suggestions={locationData.locationSuggestions}
                          onSearch={locationData.searchLocations}
                      ...
                      <div className="p-1">
                        <LocationDropdown
                          ...
                          suggestions={locationData.subLocationSuggestions}
                          onSearch={(term) =>
                            locationData.searchSubLocations(term, formData.locationStation)
                          }
                      ...
                      <div className="p-1">
                        <LocationDropdown
                          ...
                          onChange={async (value) => {
                            ...
                            const context = await fetchLocationContextByValue("landmark", value);
                            if (context?.location || context?.subLocation) {
                              setFormData(prev => ({
                                ...prev,
                                locationStation: context.location || prev.locationStation,
                                sublocation: context.subLocation || prev.sublocation,
                                landmark: value,
                              }));
                            }
                          }}
                          suggestions={locationData.landmarkSuggestions}
                          onSearch={(term) =>
                            locationData.searchLandmarks(term, formData.locationStation, formData.sublocation)
                          }
                ...
                {currentTab === 1 && (
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 mb-6 shadow-sm border border-gray-200">
                    <div className="grid gap-1 bg-white rounded border border-gray-200 p-1" style={{gridTemplateColumns: formData.parking === 'Available' ? '0.9fr 0.9fr 1fr 1.4fr 0.7fr 0.9fr' : '1fr 1fr 1fr 1fr 1fr 1fr'}}>
                      ...
                      <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">OC Available *</div>
                      ...
                      <div className="p-1">
                        <select name="ocAvailable" value={formData.ocAvailable} onChange={handleInputChange} required className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white cursor-pointer">
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 mb-6 shadow-sm border border-gray-200">
                    <div className="grid grid-cols-5 gap-1 bg-white rounded border border-gray-200 p-1">
                      ...
                      <div className="bg-gray-100 px-2 py-2 font-semibold text-sm text-slate-700 text-center rounded-sm">Terrace / Gallery</div>
                      ...
                      <div className="p-1">
                        <input name="expectedPrice" value={formData.expectedPrice} onChange={handleInputChange} placeholder="Price in Rupees" required className="w-full p-2 border border-gray-300 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white" />
                      </div>
                      <div className="p-1">
                      ...
                      <div className="p-1">
                        <div className="flex gap-1">
                          <select name="plusProperty" value={formData.plusProperty} onChange={handleInputChange} className={`p-2 border border-gray-00 rounded text-sm transition-colors focus:outline-none focus:border-blue-500 focus:shadow-sm bg-white cursor-pointer ${formData.plusProperty === 'Yes' ? 'flex-1' : 'flex-1'}`}>
...
export default ResalePropertyForm;
